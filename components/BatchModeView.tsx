...
export const BatchModeView: React.FC<BatchModeViewProps> = ({
  ...
  if (status === 'completed' && result) {
      return (
        <div className="max-w-3xl mx-auto mt-10 bg-white rounded-2xl shadow-2xl border border-stone-200 overflow-hidden animate-in fade-in zoom-in-95 duration-500">
            <div className="bg-emerald-900 p-12 text-center text-white relative overflow-hidden">
  ...
  // --- RUNNING / IDLE VIEW ---
  return (
    <div className="max-w-4xl mx-auto mt-10 bg-white rounded-2xl shadow-xl border border-stone-200 overflow-hidden">
      <div className="bg-emerald-900 p-8 flex justify-between items-center relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
          <div className="relative z-10">
            <h2 className="text-3xl font-bold text-amber-400 mb-2 serif-font">
                {status === 'running' ? 'Automatisk Bearbetning' : 'Starta Batch-process'}
            </h2>
            <p className="text-emerald-100/90 font-medium text-lg">
                {status === 'running' 
          ...
          {status === 'running' && (
              <div className="relative z-10 flex items-center gap-2 px-4 py-2 bg-emerald-800/50 text-emerald-100 rounded-full text-xs font-bold uppercase tracking-widest animate-pulse border border-emerald-700/50 shadow-lg">
      ...
      <div className="p-8">
        ...
        {status === 'running' && progress ? (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="bg-emerald-950 rounded-2xl p-8 text-white shadow-2xl relative overflow-hidden border border-emerald-900">
                    ...
                    <div className="relative z-10">
                        <div className="flex justify-between items-end mb-4">
                            <div>
                                ...
                                <div className="text-6xl font-bold serif-font tracking-tight leading-none text-white">
                                    {progress.current} <span className="text-emerald-700 text-4xl font-light">/ {progress.total}</span>
                                </div>
                            </div>
                            <div className="text-right">
                                <div className="text-2xl font-mono text-emerald-200 font-medium mb-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="bg-stone-50 border border-stone-200 p-5 rounded-2xl flex items-center gap-4">
            ...
            <div className="space-y-10">
                <div className="bg-stone-50 border border-stone-200 rounded-2xl p-10 flex flex-col items-center text-center">
                    ...
                    <p className="text-stone-500 max-w-lg mx-auto mb-8 text-lg leading-relaxed">
